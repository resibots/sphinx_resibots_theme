module.exports = function(grunt) {
  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'sphinx_resibots_theme/static/fonts/',
              filter: 'isFile'
          },
          {
              expand: true,
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'sphinx_resibots_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        options: {
          external: ['jquery'],
          alias: {
            'sphinx-resibots-theme': './js/theme.js'
          }
        },
        src: ['js/*.js'],
        dest: 'sphinx_resibots_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    clean: {
      ...
      fonts: ["sphinx_resibots_theme/static/fonts"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['sphinx_resibots_theme/**/*', 'demo_docs/**/*.rst', 'demo_docs/**/*.py'],
